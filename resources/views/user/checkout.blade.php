...
<section id="cart_items">
		<div class="container">
            ...
            <form action="{{URL::to('/save-checkout-custommer')}}" method="POST">
                    {{csrf_field()}}
			<div class="payment-options">
					<span>
						<label><input type="radio" name="checkbox" value="off" checked>Thanh toán khi nhận</label>
					</span>
					<span>
						<label><input type="radio" name="checkbox" value="onl">Thanh toán online</label>
					</span>
				...
				<div class="row">
					...
					<div class="col-sm-5 clearfix">
						<div class="bill-to">
							...
							<div class="form-one">
									...
									<input type="text" name="ship_sdt" placeholder="Số điện thoại">
									<input type="text" name="ship_address" placeholder="Địa chỉ">
                                    <label for="">Ngày giao hàng</label>
									<input type="date" name="ship_date" ><br>
                                    <label for="">Thời gian nhận hàng</label>
                                    <input type="time" name="ship_time" ><br>
                                    <input type="submit" name="send_oder" values="Gửi" class="btn btn-primary btn-sm" >
					...
					<div class="col-sm-4">
						<div class="order-message">
							<p>Ghi chú</p>
							<textarea name="ship_note"  placeholder="lưu ý khi giao hàng" rows="16"></textarea>
