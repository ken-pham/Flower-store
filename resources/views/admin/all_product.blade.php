      ...
      <table class="table table-striped b-t b-light">
        ...
        @foreach($all_product as $key => $pro)
          <tr>
            ...
            <td>{{ $pro-> species_name }}</td>
            <td>{{ $pro-> event_name }}</td>
            <td>{{ $pro-> soluong }}</td>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn muốn xóa sản phẩm này?')" href="{{URL::to('/delete-product/'.$pro ->category_id )}}" class="active" ui-toggle-class="">
